...
export class Sock {
  ...
  _nabor = () => {
    let r: TKnitRow = {
      row: `Набрать по ${this.a4} петель на каждую из 4 спиц`,
  ...
  _rezinka = () => {
    ...
    for (let i = 0; i < this.rowR; i++)
      n.push({
        row: `Вязать резинкой 1 лицевая 1 изнаночная все петли (${this.a}) ряда на 4 спицах`,
  ...
  _golenishe = () => {
    ...
    for (let i = 0; i < this.rowR1; i++)
      n.push({
        row: `Вязать лицевыми все петли (${this.a}) ряда на 4 спицах`,
  ...
  _pyatka1 = () => {
    ...
    for (let i = 0; i < this.rowP1; i++)
      n.push({
        row: `На 2 спицах (${this.a4 * 2} петлях) вязать лицевыми планку пятки `,
  ...
  _pyatka2 = () => {
    ...
    for (let i = 0; i < this.rowP2; i++)
      n.push({
        row: `На ${this.aP2} петлях вязать ряд лицевой гладью донышко пятки.
  ...
  _stopa1 = () => {
    ...
    for (let i = 0; i < this.rowS1; i++) {
      if (i % 2 > 0)
        n.push({
          row: `Провязать все петли лицевой гладью`,
        ...
        n.push({
          row: `Вязать ряд лицевой гладью, убавив 2 петли`,
          desc: `Набрать по боковинам планки пятки петли(${this.a4}) и продожить вязание стопы на всех спицах. 
                Общее количество петель  на всех спицах после вывязывания пятки ${this.a + this.adopS1 * 2}`,
        });
    }
  ...
  _stopa3 = () => {
    ...
    for (let i = 0; i < this.rowS3; i++) {
      if (i % 2 > 0)
        n.push({
          row: `Вязать лицевой гладью, убавить 4 петли в ряду равномерно`,
          desc: `Убавляем, пока на спицах не останется 8 петель. Их стягиваем на нитку `,
        });
      else
        n.push({
          row: `Вязать ряд лицевой гладью`,
          desc: `Убавляем, пока на спицах не останется 8 петель. Их стягиваем на нитку `,
        });
    }
    return n;
