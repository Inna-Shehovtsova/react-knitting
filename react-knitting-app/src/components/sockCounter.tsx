  ...
  if (isAuthorized)
    return (
      <form className="model" onSubmit={handleSumbmit}>
        <p>
          Схема вязания носков {name} размера {size}, плотности {stich}/{row}
        </p>
        ...
        <div className="counter">
          ...
          <button
            className="decrement"
            onClick={() => dispatch(getPreviosRow())}
            data-testid="counterdecr"
          >
            -
          </button>
          <p className="show" data-testid="counterinput">
            {counter}
          </p>
          <button
            className="increment"
            onClick={() => dispatch(getNextRow())}
        ...
        <div>
          ...
          <p className="rowdescription" data-testid="rowdescription">
            {rowDesc.row}
          </p>
          <button
            onClick={() => {
